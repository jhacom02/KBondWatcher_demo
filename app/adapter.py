...
def config_from_profile(
    ...
    *,
    ...
    return Config(
        ...
        excel_input_col="D",
        excel_pnl_col="F",
        excel_pnl_row_offset=0,
        excel_prefix_3y_cell="",
        excel_prefix_10y_cell="",
        excel_watch_cell="",
        excel_pnl_threshold_cell="",
        excel_pnl_sanity_band=defaults.excel_pnl_sanity_band,
        excel_status_cell="",
        excel_looking_for_cell="",
        excel_last_quote_cell="",
        excel_last_pnl_cell="",
        excel_last_action_cell="",
